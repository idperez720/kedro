...
# maverick_data_lake documentation build
...
from maverick_data_lake import __version__ as release

# -- Project information -----------------------------------------------------

project = "maverick_data_lake"
author = "Kedro"
...
htmlhelp_basename = "maverick_data_lakedoc"
...
latex_documents = [
    (
        master_doc,
        "maverick_data_lake.tex",
        "maverick_data_lake Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "maverick_data_lake",
        "Project maverick_data_lake codebase.",
        "Data-Science",
    )
]
